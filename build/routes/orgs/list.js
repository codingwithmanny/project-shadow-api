...
// Route
// ========================================================
var ListOrgs = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_k) {
        switch (_k.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, queries_1.QUERY_ORGS)({
                        ...
                        include: (_j = req === null || req === void 0 ? void 0 : req.query) === null || _j === void 0 ? void 0 : _j.include,
                        userId: userId,
                    })];
            case 1:
                _a = _k.sent(), data = _a.data, pagination = _a.pagination;
...
// Middlewares
// ========================================================
router.get('/', authMiddleware_1.default, ListOrgs);
// Exports
// ========================================================
