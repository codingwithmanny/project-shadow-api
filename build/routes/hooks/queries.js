...
exports.DELETE_ORG_HOOK = exports.CREATE_ORG_HOOK = exports.QUERY_ORG_HOOK = exports.QUERY_ORG_HOOKS = void 0;
// Imports
// ========================================================
 ...
 * @returns
 */
var QUERY_ORG_HOOKS = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    optionOrderBy = ['id', 'name', 'method', 'url', 'createdAt'].includes(orderBy)
                        ? orderBy
                        : 'id';
                ...
                case 3:
                    ...
                    options.take = take;
                    options.skip = skip;
                    return [4 /*yield*/, prisma.orgHook.findMany(options)];
                case 4:
                    data = _j.sent();
...
exports.QUERY_ORG_HOOKS = QUERY_ORG_HOOKS;
/**
 *
 * @param id
 * @param userId
 * @returns
 */
var QUERY_ORG_HOOK = function (id, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var options, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, prisma.orgHook.findFirst(options)];
            case 1:
                data = _a.sent();
                if (!data)
                    throw new errorHandlers_1.NotFound(dictionary_json_1.default.ORG_HOOKS.ERROR.READ.NOT_FOUND);
                return [2 /*return*/, { data: data }];
        }
    });
}); };
exports.QUERY_ORG_HOOK = QUERY_ORG_HOOK;
/**
 *
 * @param id
 * @param data
 * @returns
 */
var CREATE_ORG_HOOK = function (payload, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var options, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, prisma.orgHook.create(options)];
            case 3:
                data = _a.sent();
                return [2 /*return*/, { data: data }];
        }
...
exports.CREATE_ORG_HOOK = CREATE_ORG_HOOK;
/**
 *
 * @param id
 */
var DELETE_ORG_HOOK = function (id, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var options, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.QUERY_ORG_HOOK)(id, userId)];
            case 1: return [4 /*yield*/, (_a.sent()).data];
            case 2:
                if (!(_a.sent())) {
                ...
                return [4 /*yield*/, prisma.orgHook.delete(options)];
            case 3:
                data = _a.sent();
                return [2 /*return*/, { data: data }];
        }
...
exports.DELETE_ORG_HOOK = DELETE_ORG_HOOK;
